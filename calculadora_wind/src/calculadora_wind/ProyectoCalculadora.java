...
public class ProyectoCalculadora extends JFrame implements ActionListener
   {   
	   ...
	   JMenuBar contenedor;
	    ...
	    JMenuItem estandar,cientifica,programador,copiar,pegar,historial,ver_ayuda,acerca_calculadora,Volver_menu;
       ...
       public ProyectoCalculadora(String nombre)
        {
          ...
          public void  iniciarControles()
          {
        	...
        	contenedor=new JMenuBar();
              ...
              Volver_menu =new JMenuItem("Volver a menu");
           ...
           Volver_menu.addActionListener(this); 
...
// iniciar implements ActionListener  para los eventos
	  ...
	  b=Float.parseFloat(jTextField1.getText());
		  ...
		  if(e.getSource()==ver_ayuda || e.getSource()==acerca_calculadora)
		  {
			  ...
			  JOptionPane.showMessageDialog(null,"Proyecto de Calculadora Cientifica Algoritmica 1.0"+"\n"+" Autor:Juan Carlos Arcila Díaz - carlos_ad_6@hotmail.com"+"\n"+"Todos los Derechos reservados");
		  }
		  ...
		  if(e.getSource()==ProyectoCalculadora.this.jButton32)//borra todos los datos de Jtexfield
		  {
			...
			con=0;
                    ...
                    if(e.getSource()==ProyectoCalculadora.this.Volver_menu)//borra todos los datos de Jtexfield
		  {
			inicio();
		  }
